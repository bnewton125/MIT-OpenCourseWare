...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in range(65, 91):
            ...
            if letter_shift > 90:
                letter_shift -= 26
            shift_dict[chr(letter)] = chr(letter_shift)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
        best_shift = {'num': 0, 'message': '', 'shift': 0}
        for shift in range(0, 25):
            ...
            for word in message_split:
                if is_word(self.valid_words, word):
                    num_words += 1
            if num_words > best_shift['num']:
                best_shift['num'] = num_words
                best_shift['message'] = message
                best_shift['shift'] = shift
        ret = (best_shift['shift'], best_shift['message'])
        return ret
